...
public class Conexion {
    ...
    public Conexion() {
        try {
            ...
            System.err.println("‚?å Error: No se encontr√≥ el driver JDBC.");
            e.printStackTrace();
        } catch (SQLException e) {
            System.err.println("‚?å Error al conectar a la base de datos.");
            e.printStackTrace();
        }
    }
    ...
    public void cerrarConexion() {
        try {
            ...
            System.err.println("‚?å Error al cerrar la conexi√≥n.");
            e.printStackTrace();
        }
    }
}
